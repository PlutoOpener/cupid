  ...
  return (
    <section className="mt-12 w-screen">
      <div className="w-1/2 m-auto flex items-center justify-center gap-2">
        <h1 className="text-md text-xl text-gray font-light">why</h1>
        <span className="text-2xl text-green ">Cupid</span>
      </div>

      <div className="w-5/6 flex items-center justify-around flex-col gap-4  m-auto rounded-md  mt-8 p-4">
        <div className="">
        ...
        <div className="flex items-center justify-center flex-col">
          ...
          <p className="text-center text-gray">
            Cupid provides you the way to easily manage your project irespective
            of the size.
          </p>
        </div>
        <div>
